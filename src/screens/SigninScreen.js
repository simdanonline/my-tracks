...
const SigninScreen = ({ navigation }) => {
  ...
  const { state, signin, clearErrorMessage, AutoLogin } = useContext(
    AuthContext
  );
  useEffect(() => {
    AutoLogin();
    ...
    >
      ...
      <View style={style.viewStyle}>
        <Spacer>
          ...
          >
            {" "}
            ...you're few steps away from recording your tracks
          </Text>
        </Spacer>
        <Spacer>
          <TextInput
        ...
        <Spacer>
          {state.errorMessage ? (
            <Text style={style.errorMessage}>{state.errorMessage}</Text>
          ) : null}
      ...
      <TouchableOpacity
        ...
        onPress={() => Linking.openURL("mailto:contact@simdanonline.com")}
        activeOpacity={0.8}
      >
        <Text
          style={{
        ...
        >
          Powered by Simdan Online
        </Text>
        <Text style={{ textAlign: "center" }}>contact@simdanonline.com</Text>
      </TouchableOpacity>
